...
- (void)setCenterButton_centerY_ratio:(CGFloat)centerButton_centerY_ratio{
    _centerButton_centerY_ratio = centerButton_centerY_ratio;
    [self setNeedsLayout];
}

- (void)setCenterButton_centerY:(CGFloat)centerButton_centerY{
    _centerButton_centerY = centerButton_centerY;
    [self setNeedsLayout];
}
@end
